...
| Role | Model | Status |
|---|---|---|
| On-device primary | Gemma 4 E4B or Llama 3.2 3B | **Open — Sprint 0** |
...
1. On-device primary model (Gemma 4 E4B vs. Llama 3.2 3B) — Sprint 0.
2. Flutter llama.cpp plugin selection — Sprint 0.
